...
/**
 * Forge Dedicated Server mod 入口。
 *
 * <p>生命週期：
 * <ul>
 *   <li>建構子（mod 載入）— 註冊 MinecraftForge.EVENT_BUS 事件監聽</li>
 ...
 * 不註冊任何遊戲內指令（零指令保證）。
 */
@Mod(S12rytForgeMod.MOD_ID)
public final class S12rytForgeMod {
    ...
    private void onServerStarting(ServerStartingEvent event) {
        ...
        // 啟動 Web 控制台（預設埠 8080；Forge 端暫用固定埠，之後可加配置檔）
        int port = 8080;
        ...
        System.out.println("[s12ryt-mc-base] s12ryt MC 平台已啟動（Forge）");
    }
